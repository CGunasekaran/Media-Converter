...
export default function Base64Tool() {
  ...
  const downloadDecodedImage = () => {
    ...
    const extension = decodedImage.includes("image/png")
      ? "png"
      : decodedImage.includes("image/jpeg")
      ? "jpg"
      : decodedImage.includes("image/webp")
      ? "webp"
      : "png";
    ...
    <div className="space-y-6">
      <div className="bg-gradient-to-r from-orange-500/20 to-amber-500/20 border border-orange-300 dark:border-orange-700 rounded-lg p-4">
        <p className="text-sm text-white font-medium">
          <strong>🔐 Base64 Encoder/Decoder:</strong> Convert images to Base64
          strings and decode Base64 back to images
        </p>
      </div>
                ...
                <>
                  ...
                  {imageInfo && (
                    <div className="p-3 bg-gray-100 dark:bg-slate-700 rounded-lg">
                      <p className="text-sm text-gray-700 dark:text-gray-300">
                        <strong>Dimensions:</strong> {imageInfo.width} ×{" "}
                        {imageInfo.height}
                      </p>
                      <p className="text-sm text-gray-700 dark:text-gray-300">
                      ...
                      <p className="text-sm text-gray-700 dark:text-gray-300">
                        ...
                        {getBase64Length().toLocaleString()} chars
                      </p>
                    </div>
                  )}
                  ...
                  <div>
                    ...
                    <textarea
                      value={base64String}
                      readOnly
                      className="w-full h-32 p-3 border rounded-lg text-xs font-mono text-white dark:text-white bg-gray-800 dark:bg-gray-800 resize-none"
            ...
            <>
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full h-48 p-3 border rounded-lg text-xs font-mono text-white dark:text-white bg-gray-800 dark:bg-gray-800 resize-none"
